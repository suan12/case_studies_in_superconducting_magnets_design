...
\begin{figure}[htbp]
	...
	\caption{General energy margin vs. normalized transport current plot
...
\begin{figure}[htbp]
	...
	\caption{Normalized voltage vs. normalized current traces for αsk =0.1, 1, and 2.}
\end{figure}
...
\begin{figure}[htbp]
	...
	\caption{Ic vs. T plot (solid) for a Hybrid III Nb-Ti conductor at 10 T. The
...
\begin{figure}[htbp]
	...
	\caption{gj(T) plot (solid) and q(T) plot (dotted);gj(T)
