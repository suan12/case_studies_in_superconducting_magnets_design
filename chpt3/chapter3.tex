...
&=5.25  \qquad (\mbox{到}\quad E_4)\\
&\simeq -2.9531\qquad   (\mbox{到}\ E_6)\\
&\simeq 1.3535\qquad (\mbox{到}\ E_8)\\
&\simeq -0.5499\qquad   (\mbox{到}\ E_{10})\\
&\simeq 0.2062 \qquad (\mbox{到}\ E_{12})\\
&\simeq -0.0730\qquad   (\mbox{到}\ E_{14})\\
&\simeq 0.0248 \qquad  (\mbox{到}\ E_{16})\\
&\simeq-0.0081\qquad  (\mbox{到}\ E_{18})\\
...
\begin{align*}
F_{z}(0)=&-\frac{\mu_{o}}{2}\left(\frac{NI}{2b}\right)^{2}\left\{2b\sqrt{4a^{2}+b^{2}}[K(k_{b})-E(k_{b})]
&-2b\sqrt{4a^{2}+4b^{2}}[K(k_{2b})-E(k_{2b})]\right\}\tag{3.41a}
\end{align*}
...
\begin{align*}
0.1(8000)(9.81)=\frac{9(14)^2(0.67)^6}{4(4\pi\times 10^{-7})}\left[\frac{1}{y_{0.1g}^2+2.75^2}\right]^{3.5}\times\left[1+\frac{4(2.75)}{y_{0.1g}^2+2.75^2}\right]\frac{y_{0.1g}}{\sqrt{y_^2_{0.1g}+2.75^2}}
\end{align*}
...
&=\frac{\mu_0N^2I}{\pi}\left(R\pi+\pi\frac{a^2-R^2}{\sqrt{R^2-a^2}}\right)=\mu_0N^2RI\left[1-\sqrt{1-(\frac{a}{R})^2}\right]\tag{S18.19}
\end{align*}
