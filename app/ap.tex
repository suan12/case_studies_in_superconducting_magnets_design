...
密度($T_b$,liquid)\ \ \ \ \ \ \ \ \ $[\mathrm{kg/m^3}]$ & 125 & 70.8 & 1206 & 807 & 1394 & 1141 \\ \hline
密度($T_b$,vapor)\ \ \ \ \ \ \ \ \ $[\mathrm{kg/m^3}]$ & 16.9 & 1.33 & 9.37 & 4.60 & 5.77 & 4.47 \\ \hline
...
\begin{tabular}[c]{@{}l@{}}密度($T_b$,liquid)/密度(273K)\\ 密度($T_b$,liquid)/密度(293K)\end{tabular} & \begin{tabular}[c]{@{}l@{}}900\\ 753\end{tabular} & \begin{tabular}[c]{@{}l@{}}787\\ 853\end{tabular} & \begin{tabular}[c]{@{}l@{}}1340\\ 1446\end{tabular} & \begin{tabular}[c]{@{}l@{}}645\\ 697\end{tabular} & \begin{tabular}[c]{@{}l@{}}781\\ 844\end{tabular} & \begin{tabular}[c]{@{}l@{}}798\\ 862\end{tabular} \\ \hline
\end{tabular}
\end{table}
