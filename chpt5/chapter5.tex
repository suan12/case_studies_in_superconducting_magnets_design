...
\hline
\multirow{2}{*}{金属} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}$\rho_e$\\ $\left[\ \mathrm{n\Omega m}\right]$\end{tabular}} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}k\\ $\left[\ \mathrm{W/mK}\right]$\end{tabular}} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}C\\ $\left[\ \mathrm{J/m^3K}\right]$\end{tabular}} & \multicolumn{2}{c|}{Diffusivity$\left[\ \mathrm{m^2/s}\right]$} \\ \cline{5-6} 
& & & & $D_{mg}$ & $D_{th}$ \\ \hline
...
[5.13] A. Nabialek, M. Niewczas, H. Dabkowska, A. Dabkowski, J.P. Castellan, and B. D. Gaulin, “Magnetic flux jumps in textured Bi2Sr2CaCu2O8+δ,” Phys. Rev. B67, 024518 (2003).
