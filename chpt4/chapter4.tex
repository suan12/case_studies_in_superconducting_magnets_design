...
\colorbox{red}{表4.3}
\begin{table}[]%表4.3 需要加\usepackage{multirow}
	  \centering
	\caption{湿式和干式超导磁体的冷却方式} \label{coolingmethod}
	\begin{tabular}{|c|c|c|c|c|c|c|c|}
		\hline
		
		\multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}T\\ {[}K{]}\end{tabular}} & \multirow{2}{*}{\begin{tabular}[c]{@{}c@{}}h\\ {[}k{]}\end{tabular}} & \multicolumn{2}{c|}{LHe Required {[}liter{]}}                                                 & \multicolumn{2}{c|}{LNe required {[}liter{]}}                                                 & \multicolumn{2}{c|}{LN Required {[}liter{]}}                                                  \\ \cline{3-8} 
		&                                                                      & \begin{tabular}[c]{@{}c@{}}a\\ b\end{tabular} & \begin{tabular}[c]{@{}c@{}}q\\ q\end{tabular} & \begin{tabular}[c]{@{}c@{}}a\\ b\end{tabular} & \begin{tabular}[c]{@{}c@{}}q\\ q\end{tabular} & \begin{tabular}[c]{@{}c@{}}a\\ b\end{tabular} & \begin{tabular}[c]{@{}c@{}}q\\ q\end{tabular} \\ \hline
...
\begin{table}[]%表4.5   需要加\usepackage{multirow}
	  \centering
	\caption{湿式和干式超导磁体的冷却方式} \label{coolingmethod}
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
		\hline
		$T_i[\mathrm{K}]$                    & $T_{op}[\mathrm{K}]$  & \multicolumn{8}{c|}{$\tilde{M}_{cu}[\mathrm{kg}]$}                           \\ \hline
		\multicolumn{2}{|c|}{$\tau_{cn}[hour/day]\rightarrow$}   & 1   & 2   & 4    & 12  & 1   & 2    & 10   & 20    \\ \hline
...
\begin{table}[]%表4.6
	...
	\begin{tabular}{|c|c|c|}
		\hline
		Material       & k{[}W/mK{]} & $\nu[\mu Pa s]$     \\ \hline
		HL II          & $\sim100,000^*$         & $0.01\sim0.1$  \\ \hline
		He I(4.2,liq.) & 0.02        & $\sim3$     \\ \hline
		Copper(4.2K)   & $\sim400$         & -     \\ \hline
		Water          & $\sim1$           & $\sim1,000$ \\ \hline
		Air(293K)      & $\sim0.05$        & $\sim20$    \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[]
	...
	\begin{tabular}{|l|l|l|}
		\hline
		Metal(surface)         & $a_k[\ \mathrm{W/cm^2K^{n_k}}]$    & $n_k$   \\ \hline
		Aluminum(polished)     & 0.05 & 3.4 \\ \hline
		Copper(polished)       & 0.02 & 4.0 \\ \hline
		Copper(polished)       & 0.02 & 3.8 \\ \hline
		Copper(as-received)    & 0.05 & 2.8 \\ \hline
		pper(solder-coated)    & 0.08 & 3.4 \\ \hline
		Copper(varnish-coated) & 0.07 & 2.1 \\ \hline
		Silver(polished)       & 0.06 & 3.0 \\ \hline
	\end{tabular}
\end{table}
