...
>>>>>>> e22c8f556c8eae444b4ec02aeeac95c94655abbe
\end{equation}
\begin{equation}% 4.73
...
\end{equation}
\begin{equation}
\frac{[\alpha_\ell]_{cs}e^{[\alpha_\ell]_{cs}\xi_{cs}}(T_\ell-T_{cs})}{(e^{[\alpha_\ell]_{cs}\xi_{cs}}-1)}=\frac{\beta_{cs}e^{\frac{[\alpha_\ell]_{cs}\xi_{cs}}{2}(T_\ell-T_{cs})}{e^{\frac{[\alpha_\ell]_{cs}}{2}}\sin\beta_{cs}(1-\xi_{cs})}
\end{equation}
\begin{equation}
...
\end{equation}
\begin{equation}
	Q_j=\frac{\tilde{\rho}_xI_o(I_o-I_{c\ell})\ell}{[A_m]_{cs}e^{\frac{[\alpha_\ell]_{cs}}{2}\sin\beta_{cs}(1-\xi_{cs})}\int_{xi_{cs}}^{1}e^{[\alpha_\ell]_{cs}\xi}\sin\beta_{cs}(\xi-\xi_{cs})d\xi
\end{equation}
\begin{equation}
Q_j=\frac{4\tilde{\rho}_xI_o(I_o-I_{c\ell})\ell e^{\frac{[\alpha_\ell]_{cs}\xi_{cs}}{2}}{[A_m]_{cs}e^{\frac{[\alpha_\ell]_{cs}}{2}\sin\beta_{cs}(1-\xi_{cs})([\alpha_\ell]_{cs}^{2}+4\beta_{cs}^{2})} 
