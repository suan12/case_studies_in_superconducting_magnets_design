...
\hline		
% \multirow{2}{*}{$T_i$\\[K]} & \multirow{2}{*}{$h_{p_{cu}}$\\[kJ/kg]} & \multicolumn{2}{l|}{c所需LHe量[L]} & \multicolumn{2}{l|}{所需LNe量[L]} & \multicolumn{2}{l|}{所需LN2量[L]} \\ \cline{3-8}   
%     &      & f``理想"\\(方程4.2) & ``浸泡"\\(方程4.3) & ``理想"\\(方程4.2) & ``浸泡"\\(方程4.3) & ``理想"\\(方程4.2) & ``浸泡"\\(方程4.3) \\ \hline
\multirow{2}{*}{a} & \multirow{2}{*}{b} & \multicolumn{2}{l|}{c} & \multicolumn{2}{l|}{d} & \multicolumn{2}{l|}{e} \\ \cline{3-8} 
                   &                    & f          & g         & h          & i         & j          & k         \\ \hline
...
\hline
T[$\ \mathrm{K}$ ]  & ${Q_r(T)[\ \mathrm{W}]}$  & $C_{cu}[\ \mathrm{J/m^3K}]$    & $\kappa(T)[\ \mathrm{s/m^3K}]$   \\ \hline
...
\multicolumn{2}{|c|}{$\tau_{cn}[小时/\textbf{天}]\rightarrow$}   & 1   & 2   & 4    & 12  & \textbf{1}  &\textbf{2} &\textbf{10}&\textbf{20}\\ \hline
...
铝(抛光) & 0.05 & 3.4 \\ \hline
铜(抛光) & 0.02 & 4.0 \\ \hline
铜(退火，抛光) & 0.02 & 3.8 \\ \hline
铜(来样) & 0.05 & 2.8 \\ \hline
铜(表面涂焊料) & 0.08 & 3.4 \\ \hline
铜(表面涂漆) & 0.07 & 2.1 \\ \hline
银(抛光) & 0.06 & 3.0 \\ \hline
	\end{tabular}
\end{table}
...
\begin{tabular}{|c|c|c|c|c|c|}
\hline
\multicolumn{3}{|c|}{Helium} & \multicolumn{3}{c|}{Hydrogen} \\ \hline
...
$T$[K] & SNe & $SN_2$ & Cu & SNe & $SN_2$ & Cu \\ \hline
...
\caption{几种热传感器的信号水平($V$)和敏感性($\delta V/\delta T$)的近似值。二极管[4.44]；电阻[4.44]；热电偶[4.45]}
	\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
		\hline
传感器 & 2K & 4K & 10K & 20K & 50K & 100K & 200K & 300K \\ \hline
...
\begin{tabular}[c]{@{}l@{}}GaAlAs $\ \mathrm{V \left[V\right]}$\\ $\delta V/\delta T\left[\ \mathrm{mV/K}\right]$ V\end{tabular} & \begin{tabular}[c]{@{}c@{}}5.5\\ -210\end{tabular} & \begin{tabular}[c]{@{}c@{}}5.1\\ -210\end{tabular} & \begin{tabular}[c]{@{}c@{}}4.1\\ -145\end{tabular} & \begin{tabular}[c]{@{}c@{}}2.7\\ -110\end{tabular} & \begin{tabular}[c]{@{}c@{}}1.5\\ -30\end{tabular} & \begin{tabular}[c]{@{}c@{}}1.4\\ -1.5\end{tabular} & \begin{tabular}[c]{@{}c@{}}1.1\\ -2.6\end{tabular} & \begin{tabular}[c]{@{}c@{}}0.9\\ -2.7\end{tabular} \\ \hline
...
\multirow{10}{*}{\begin{tabular}[c]{@{}l@{}}Overall width $\left[\ \mathrm{mm}\right]$\\ Overall thickness $\left[\ \mathrm{mm}\right]$\\ Bi2223 filling(volume) $\left[\%\right]$\\ Au content $\left[\ \mathrm{wt\%}\right]$\\ Ag-Au cross section,$a_m$ $\left[\ \mathrm{mm^2}\right]$\\ Tape cross sectiong $\left[\ \mathrm{mm^2}\right]$\\ $i_c(T_l)(@77.3K@B_\bot=0.2T)$ $\left[\ \mathrm{A}\right]$\\ $i_c(T_0)(@4.2K@B_\bot=0.2T)$ $\left[\ \mathrm{A}\right]$\\ $\tilde{k}(4.2-77K)$ $\left[\ \mathrm{W/cm K}\right]$\\ $\tilde{p}_x(T_l-77K)$ $\left[\ \mathrm{\mu\Omega cm}\right]$\end{tabular}} & \multirow{10}{*}{\begin{tabular}[c]{@{}c@{}}4.2\\ 0.228\\ 42\\ 5.3\\ 0.555\\ 0.958\\ 80\textasciicircum{}*\\ $455.5\dagger$\\ 0.327\\ 1.0\end{tabular}} \\
\hline
\end{tabular}
\end{table}
...
\caption{常规金属(黄铜)带参数}
	\begin{tabular}{|l|c|}
		\hline
Parameters & Value \\ \hline
\multirow{6}{*}{\begin{tabular}[c]{@{}l@{}}单带宽度$\left[\ \mathrm{mm}\right]$\\ 单带 厚度$\left[\ \mathrm{mm}\right]$\\ 并联带数目$\left[\ \mathrm{mm}\right]$\\ $\left[A_n\right]_{fs}$和$\left[A_n\right]_{cs}$ $\left[\ \mathrm{cm^2}\right]$\\ $\tilde{k}_n(4.2-77K)$ $\left[\ \mathrm{W/cm K}\right]$ \\ $\tilde{p}_n(4.2-77K)$ $[\mathrm{\mu}\Omega$cm}]\end{tabular}} & \multirow{6}{*}{\begin{tabular}[c]{@{}c@{}}4.203\\ 0.344\\ 120\\ 1.735\\ 0.350\\ 2.25\end{tabular}} \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|c|c|c|}
\hline
\begin{tabular}[c]{@{}c@{}}Guess Value fo\\ $\xi_{cs}$\end{tabular} & \begin{tabular}[c]{@{}c@{}}Eq.4.96b\\ $\beta_{cs}^{n*}$\end{tabular} & \begin{tabular}[c]{@{}c@{}}Left-Hand Side\\ Eq.4.83\end{tabular} \\ \hline
...
\hline
参数 & 数值 \\ \hline
\multirow{10}{*}{\begin{tabular}[c]{@{}l@{}}Operating range$(T_o-T_{l_{cu}})$ $\left[\ \mathrm{K}\right]$\\ Active area,$A_{cu}$ $\left[\ \mathrm{cm^2}\right]$\\ Active length,$l_{cu}$ $\left[\ \mathrm{cm}\right]$\\ Area exposed to coolant $\left[\ \mathrm{cm^2}\right]$\\ $\tilde{k}_{cu}$(77-300K) $\left[\ \mathrm{W/cm K}\right]$\\ $\tilde{c}_{fl}$(77-300K):helium $\left[\ \mathrm{J/gK}\right]$\\ $\tilde{c}_{fl}$(77-300K):nitrogen $\left[\ \mathrm{J/gK}\right]$\\ $h_{n2}$(77.3K) $\left[\ \mathrm{J/g}\right]$\\ $\rho_o$(77K) $\left[\ \mathrm{\mu\Omega cm}\right]$\\ $\gamma_{cu}$(77-300K) $\left[\ \mathrm{n\Omega cm/K}\right]$\end{tabular}} & \multirow{10}{*}{\begin{tabular}[c]{@{}c@{}}77.3-300\\ 1.19\\ 38\\ 12,650\\ 4\\ 5.28\\ 1.04\\ 199\\ 0.22\\ 7.01\end{tabular}} \\
& \\
& \\
& \\
& \\
...
\begin{tabular}{|c|c|c|c|c|}
	\hline
\multicolumn{3}{|c|}{Eq.4.88b} & Eq.4.88b & Eq.4.87c \\ \hline
$\beta_{cu}\left[degree\right]$ & -cot$\beta_{cu}$ & $\beta_{cu}$ & $\alpha_{cu}$ & $\beta_{cu}$ \\ \hline
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\multicolumn{2}{|c|}{Eq.4.93} & Eq.4.95a & \multicolumn{2}{c|}{Eq.4.95b} & \multicolumn{2}{c|}{Eq.4.94} \\ \hline
...
\caption{$\ell_{\ell q}，\beta^\prime_{cu}$和$\alpha^\prime_{cu}$的确定}                                                                                   
	\begin{tabular}{|l|c|c|c|c|c|}
		\hline
\multirow{2}{*}{Material} & \multicolumn{3}{c|}{$\tilde{k}\left[\ \mathrm{W/mK}\right]$} & $\sigma_U\left[\ \mathrm{MPa}\right]$ & $\tilde{k}/\sigma_U\left[\ \mathrm{m^2/Ks}\right]\dagger$ \\ \cline{2-6} 
& 4-80K & 4-300K & 80-300K & 295K &(80-300K) \\ \hline
G-10 & 0.25 & 0.50 & 0.56 & 280 & $2\times10^{-9}$ \\ \hline
Stainless Steel304 & 4.5 & 11 & 13 & 1300 & $10\times10^{-9}$ \\ \hline
Brass & 24 & 55 & 65 & 400 & $2\times10^{-7}$ \\ \hline
Copper & 1300 & 660 & 460 & 250 & $2\times10^{-6}$ \\ \hline
	\end{tabular}
\end{table}