...
solid nitrogen, $[\Delta t(10 K\rightarrow 15 K)]_{15 litter}^{0.25 W}\simeq 27.1$ h computed in b), the volume of solid neon,$V_{Ne}(10 K\rightarrow 15 K)$, is given by:
...
1.22 h)=15 K$, resulting in $[\Delta t(10 K\rightarrow 15 K)]_{1 litter}^{1 W}\simeq 0.89$ h for SNe; for 1-liter SN2:
$[\Delta t(10 K\rightarrow 15 K)]_{1 litter}^{1 W}\simeq 0.486$ h. We thus have:
\begin{equation*}% page261
V_{Ne}(10K \rightarrow 15K)=\frac{(0.486h)}{0.89h}(15liter)\simeq 8.2 liter\simeq\frac{1}{2}\times(15 liter)
\end{equation*}

e) From Fig. 4.18 we note that for 1-liter solid nitrogen, $T(t\simeq 0.6 h)=15 K$ and
$T(t\simeq 17.75 h) = 60 K$, or  $[\Delta t(15 K\rightarrow 60 K)]_{1 litter}^{1 W}\simeq 17.15 h$. For an average heat
...
h) We proceed as in g) except here an energy absorption at 35.61 K, $\Delta h(35.61 K)=8.2 J/cm3$, must be added. Also, the enthalpy area computation must be performed over two temperature ranges, 35–35.61 K and 35.61–40 K. Thus:
\begin{align*}% page262
...
\simeq&0.98J/cm^3+8.2J/cm^3+5.75J/cm^3\simeq14.9J/cm^3\\\notag
\end{align*}
\begin{align*}
