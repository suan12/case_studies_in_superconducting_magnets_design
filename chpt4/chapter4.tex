...
\multirow{2}{*}{$T_i$[K]} & \multirow{2}{*}{$h_{p_{cu}}$[kJ/kg]} & \multicolumn{2}{c|}{所需LHe量[L]} & \multicolumn{2}{c|}{所需LNe量[L]} & \multicolumn{2}{c|}{所需$\mathrm{LN_2}$量[L]} \\ \cline{3-8} 
    &     & ``理想"模式(方程4.2)& ``浸泡"模式(方程4.3) & ``理想"模式(方程4.2) &``浸泡"模式(方程4.3) & ``理想"模式(方程4.2) & ``浸泡"模式(方程4.3)\\ \hline
...
\begin{tabular}[c]{@{}c@{}}$T_{wm}\rightarrow T_{cl}$\\ [K]\end{tabular} & \begin{tabular}[c]{@{}c@{}}$\eta_g$\\ $\left[\ \mathrm{W/m^2PaK}\right]$\end{tabular} & \begin{tabular}[c]{@{}c@{}}$q_g$\\ $\left[\ \mathrm{mW/m^2}\right]$\end{tabular} & \begin{tabular}[c]{@{}c@{}}$T_{wm}\rightarrow T_{cl}$\\ [K]\end{tabular} & \begin{tabular}[c]{@{}c@{}}$\eta_g$\\ $\left[\ \mathrm{W/m^2PaK}\right]$\end{tabular} & \begin{tabular}[c]{@{}c@{}}$q_g$\\ $\left[\ \mathrm{mW/m^2}\right]$\end{tabular} \\ \hline\hline
