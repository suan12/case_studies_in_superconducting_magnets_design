...
\begin{figure}
  \centering
 \includegraphics[scale=0.7]{figures/meissnereffect.png}
  \caption{
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/acdcresponse.png}
  \caption{
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/MHcurve.png}
  \caption{
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/tcvsyear.png}
  \caption{
几种代表性超导体$T_c$和发现年份
}\label{tcvsyear}
\end{figure}
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/criticalsurface.eps}
  \caption{
典型第II类超导体的临界面
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/temperatureeffect.png}
  \caption{
温度对磁体的五个关键点的影响
...
\begin{figure}
  \centering
 \includegraphics[scale=0.7]{figures/tsplot.jpg}
...
\begin{figure}
  \centering
 \includegraphics[scale=0.6]{figures/sccircuit.png}
  \caption{
